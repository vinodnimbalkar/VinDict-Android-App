	...
	angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function(e, n) {
		...
		return {
			createCalendar: function(r) {
				var o = e.defer(),
					t = n.plugins.calendar.getCreateCalendarOptions();
		...
		this.$get = ["$q", "$window", "$cordovaFileError", function(e, n, r) {
			return {
				...
				createDir: function(o, t, i) {
					var a = e.defer();
					/^\//.test(t) && a.reject("directory cannot start with /"),
						i = i ? !1 : !0;
					var c = {
						create: !0,
						exclusive: i
		...
		return {
			download: function(r, o, t, i) {
				var a = e.defer(),
					c = new FileTransfer,
					u = t && t.encodeURI === !1 ? r : encodeURI(r);
		...
		return {
			...
			addCustomDimension: function(r, o) {
				var t = e.defer();
				return n.analytics.addCustomDimension(r, o, function() {
					t.resolve()
				}, function(e) {
					t.reject(e)
				}), t.promise
		...
		function r(e) {
			angular.isDefined(s) || (s = n(function() {
				0 > d && (d = e.getDuration(), a && d > 0 && a.notify({
					duration: d
		...
		return {
			show: function(n, r, o) {
				return o = o || !1, e.plugins.spinnerDialog.show(n, r, o)
			},
			hide: function() {
